...
local lsp_keymappings = {
	...
	normal_mode = {
		...
		["<leader>ka"] = "<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>",
		["<leader>kr"] = "<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>",
		["<leader>kl"] = "<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>",
